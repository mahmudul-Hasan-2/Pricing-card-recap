...
const Card = ({ pricing }) => {
    ...
    return (
        <div className='bg-gradient-to-br from-gray-800/50 via-gray-900/80 to-black/50 p-8 sm:p-10 text-start rounded-2xl space-y-5 duration-1000 hover:-translate-y-3'>
            ...
            {
                pricing.isPopular && <div class="badge badge-error bg-[#26ff0097] text-white rounded-full text-center w-[60%] sm:w-[44%] py-1">Most Popular</div>
            }
            <div className='flex items-center justify-between'>
                <p>{pricing.desc}</p>
            </div>
            ...
            <div className='flex items-end'>
                <button className='btn btn-primary duration-1000 hover:bg-blue-800 hover:border-blue-800'>{pricing.btn}</button>
            </div>
        </div>
    );
};
